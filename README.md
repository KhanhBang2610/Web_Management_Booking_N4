...
1. Check phiên bản net SDK máy local: ``dotnet --list-sdks``
...
2. Tải phiên bản: ``dotnet tool install --global dotnet-ef --version 9.0.0`` (máy dùng phiên bản nào thì thay thành số đó)
3. Tạo database My SQL workbench mẫu:
```
-- 1. Tạo Database
